                        ...
                        items: vec![
                            ...
                            html! {
                                <span>
                                    ...
                                    <a href="/blog/2020/6/22/nlp-series-1/">{"Part 1"}</a>{" and "}
                                    <a href="/blog/2020/6/22/nlp-series-1/">{"Part 2"}</a>
                                </span>
                            },
                            html! {
                                <span>
                        ...
                        items: vec![
                            html! {
                                <span>
                                    ...
                                    <a href="/blog/2020/3/25/notes-1-normalization/">{"series"}</a>{" of posts on notes that I've been making for myself about certain ML topics and papers."}
                                </span>
                            },
                            html! {
                                <span>
                                    {"I've also finished writing a long-form (~5k words) two part blog post on
                                    the NLP research project I was talking about above: "} <a href="/blog/2020/6/22/nlp-series-1/">{"Part 1"}</a>{" and "}
                                    <a href="/blog/2020/6/22/nlp-series-1/">{" Part 2"}</a>
                                </span>
                            },
                            html! {
                                <span>
                                    {"I'm currently (kinda) working on polishing up a really "} <a href="/blog/2020/8/02/l2/">{"long post"}</a>{" on how to build a PyTorch-style machine learning library in Rust."}
                                </span>
                            },
                        ],
                    },
